...
ox.config(log_console=True, use_cache=True, cache_folder = '/home/diogo_mota/Dropbox/Diogo_Rede_simetria/Beta_Experiment/Network_Data') ## mudar o path onde estao os jsons
...
cities = ox.geocode_to_gdf(['San Francisco', 'San Mateo'],which_result = result)
...
n = 100 ## Change number of pairs here
...
df_paths.to_csv('/home/diogo_mota/Dropbox/Diogo_Rede_simetria/Beta_Experiment/'+city_name+'/'+city_name+'_100k_paths_no_shuffle.dat') ## mudar o path onde guardar o dataframe
