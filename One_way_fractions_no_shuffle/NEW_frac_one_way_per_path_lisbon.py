...
paths = pd.read_csv('/home/diogo_mota/Dropbox/Diogo_Rede_simetria/Beta_Experiment/Lisbon/Lisbon_100k_paths_no_shuffle.dat', index_col=0) ## mudar aqui o caminho
...
save.to_csv('Lisbon_fracoes.dat') ## escrever onde guardar aqui
