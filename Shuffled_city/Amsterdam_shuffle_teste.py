...
for number in range(10):
    ...
    fig.savefig('/Shuffle_maps/Full_'+city_name+'_shuffled_new_algorithm_'+str(number)+'_teste.png') ## city and neighbors
    ...
    fig.savefig('/Shuffle_maps/'+city_name+'_shuffled_new_algorithm_'+str(number)+'_teste.png') ## city only
